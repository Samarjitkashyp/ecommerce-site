        ...
        <div class="form-card">
            <form action="{{ route('admin.menus.update', $menu->id) }}" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3" id="categoryField" style="display: {{ $menu->type == 'category' ? 'block' : 'none' }};">
...
$(document).ready(function() {
    ...
    function toggleFields() {
        ...
        $('#urlField, #routeField, #categoryField').hide();
        ...
        $.ajax({
            ...
            error: function(xhr) {
                ...
                if (xhr.status === 422) {
                    ...
                    showNotification(xhr.responseJSON?.message || 'Error updating menu', 'error');
                }
            }
        });
    });
